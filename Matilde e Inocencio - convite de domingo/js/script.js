...
document.addEventListener('DOMContentLoaded', () => {
  ...
  rsvpForm.addEventListener('submit', (e) => {
    ...
    let texto = `*Confirmação de Presença — Casamento Matilde & Inocencio*\n\n`;
    texto += `*Nome:* ${nome}\n`;
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  const assinatura = document.querySelector(
    ".em-assinatura"
  );


  /* Observa os cartões quando entram na tela */
  const observer = new IntersectionObserver(
    function (entries) {
