...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const WHATSAPP_NUMBER = '258871009491';
  ...
  const WEDDING_DATE = new Date('2026-08-07T17:00:00');
  ...
  rsvpForm.addEventListener('submit', (e) => {
    ...
    let texto = `*Confirmação de Presença — Casamento Nilza & Pio *\n\n`;
    texto += `*Nome:* ${nome}\n`;
  ...
  const SEU_NUMERO = '258871009491'; // o teu número com código do país, sem + nem espaços
...
const GOOGLE_SCRIPT_URL = 'https://script.google.com/macros/s/AKfycbyIhr8uW78bwpeQp_UfC-KO9u-cpBWA_DT671ERXAxnv5Ra8Hzfo5-VD5lGYHT9bdQ0/exec';
