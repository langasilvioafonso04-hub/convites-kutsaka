 // ---------- Reveal on scroll ----------
  ...
  const WHATSAPP_NUMBER = '258842987507';
  ...
  rsvpForm.addEventListener('submit', (e) => {
    ...
    let texto = 'Confirmação de presença - Aniverário de Nyorai Notiço\n\n';
    texto += `Nome: ${nome}\n`;
...
const GOOGLE_SCRIPT_URL = 'https://script.google.com/macros/s/AKfycbzyFzwdrGv65Dth6sMOGr_J9blOlpljDLSMW5id3oyoTY4sYgOqYdzbBesJSPB4bBQc1A/exec';
