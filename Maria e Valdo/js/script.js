...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const WEDDING_DATE = new Date('2026-10-31T11:00:00');
  ...
  const SEU_NUMERO = '258841989354'; // o teu número com código do país, sem + nem espaços
...
const GOOGLE_SCRIPT_URL = 'https://script.google.com/macros/s/AKfycbwSudd6zPPj2vsoXT3QkXRMWnbzQjdKY1PbijQJOhbf7l3O0olNMGLQlR6PyavEsPN2/exec';
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  const storyElement = document.querySelector(".reveal-left");
